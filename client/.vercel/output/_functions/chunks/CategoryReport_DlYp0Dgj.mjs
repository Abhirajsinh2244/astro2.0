...
function CategoryReport({ transactions }) {
  ...
  const { categoryData, totalSpend } = useMemo(() => {
    ...
    return { categoryData: mappedData, totalSpend: aggregatedTotal };
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 font-medium mt-1", children: "Allocation of expenses by category." })
      ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsx("div", { className: "bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col", children: /* @__PURE__ */ jsxs("div", { className: "flex-1 min-h-[300px] flex items-center justify-center relative", children: [
        categoryData.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-center", children: /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-gray-400 uppercase tracking-widest", children: "No Data Available" }) }) : /* @__PURE__ */ jsx("div", { className: "w-full h-[300px]", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(PieChart, { children: [
          /* @__PURE__ */ jsx(
            Pie,
            {
              data: categoryData,
              ...
              stroke: "#ffffff",
              paddingAngle: 2,
              children: categoryData.map((entry, index) => /* @__PURE__ */ jsx(Cell, { fill: CHART_COLORS[index % CHART_COLORS.length] }, `cell-${index}`))
            }
          ),
          /* @__PURE__ */ jsx(
            Tooltip,
        ...
        categoryData.length > 0 && /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center pointer-events-none", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col", children: /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto pr-2", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm text-left", children: [
        /* @__PURE__ */ jsx("thead", { className: "border-b border-gray-100", children: /* @__PURE__ */ jsxs("tr", { children: [
        ...
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50", children: categoryData.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 3, className: "py-8 text-center text-sm font-bold text-gray-400 uppercase tracking-widest", children: "No data available" }) }) : categoryData.map((item, index) => /* @__PURE__ */ jsxs("tr", { className: "group hover:bg-gray-50/50 transition-colors", children: [
          ...
          /* @__PURE__ */ jsx("td", { className: "py-4 text-right", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-3", children: [
            ...
            /* @__PURE__ */ jsxs("span", { className: "w-10 text-gray-500 text-xs font-bold tracking-wider", children: [
