    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 font-medium mt-1">Allocation of expenses by category.</p>
        </div>
          ...
          <div className="flex-1 overflow-y-auto pr-2">
            <table className="w-full text-sm text-left">
              ...
              <tbody className="divide-y divide-gray-50">
                {categoryData.length === 0 ? (
                  <tr>
                    <td colSpan={3} className="py-8 text-center text-sm font-bold text-gray-400 uppercase tracking-widest">No data available</td>
                  </tr>
                ) : (
                    ...
                    <tr key={item.category} className="group hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="py-4 text-right">
                        <div className="flex items-center justify-end gap-3">
                          ...
                          <span className="w-10 text-gray-500 text-xs font-bold tracking-wider">
